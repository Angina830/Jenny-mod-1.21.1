...
public enum b1 {
  ...
  public b1 followUp = null;
  
  public boolean useBoyCam;
  
  public boolean hideNameTag;
  
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2) {
  ...
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3) {
    this.useBoyCam = paramBoolean3;
  }
  
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4) {
    this.useBoyCam = paramBoolean3;
    this.hideNameTag = paramBoolean4;
  }
  
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, float paramFloat1, float paramFloat2, boolean paramBoolean3) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
  ...
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, float paramFloat1, float paramFloat2, boolean paramBoolean4) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
    this.maxGirlPitch = paramFloat1;
  ...
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, b1 paramb1) {
    this.length = paramInt2;
    this.followUp = paramb1;
  }
  
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt2, b1 paramb1) {
    this.length = paramInt2;
    this.followUp = paramb1;
    this.useBoyCam = paramBoolean3;
  }
  
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt2, b1 paramb1, float paramFloat1, float paramFloat2, boolean paramBoolean4) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
    this.length = paramInt2;
  ...
  b1(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, int paramInt2, b1 paramb1) {
    this.length = paramInt2;
    this.followUp = paramb1;
...
/* Location:              C:\Users\zakur\Downloads\Jenny-Mod-Forge-1.12.2-v1.8.0.jar!\com\schnurritv\sexmod\b1.class
